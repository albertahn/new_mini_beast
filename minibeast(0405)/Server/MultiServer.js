...
var userTeam={};
        ...
        userNames[socket.id] = ret[0];    //client id      
        userPos[ret[0]] = ret[1];         //position 
        userCharacter[ret[0]] = ret[2];    //char
        userTeam[ret[0]] = ret[3];        //team
